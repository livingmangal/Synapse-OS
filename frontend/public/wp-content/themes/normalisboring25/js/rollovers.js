            ...
            if (!is_mobile) {
                ...
                elem.addEventListener('mouseenter', (event) => {
                    ...
                    if (elem.classList.contains('btn--menu')) {
                        if (typeof header_btn_tl !== 'undefined' && header_btn_tl && typeof header_btn_tl.progress === 'function' && header_btn_tl.progress() == 1) {
                            gsap.killTweensOf(elem)
                            gsap.killTweensOf(elem.querySelector(':scope > span'))
                        }
                    } else if (elem.classList.contains('header__footer__btn')) {
                        if (typeof header_anchors_tl !== 'undefined' && header_anchors_tl && typeof header_anchors_tl.progress === 'function' && header_anchors_tl.progress() == 1) {
                            gsap.killTweensOf(elem)
                            gsap.killTweensOf(elem.querySelector(':scope > span'))
                        }
                    } else {
                    ...
                    gsap.fromTo(elem.querySelector(':scope > span'), { x: 0, y: 0 }, {
                        x: spanPos[0], y: spanPos[2], duration: dur, ease: "power3.in", onComplete: () => {
                ...
                elem.addEventListener('mouseleave', (event) => {
                    ...
                    gsap.fromTo(elem.querySelector(':scope > span'), { x: 0, y: 0, color: colorEnd }, {
                        x: spanPos[0], y: spanPos[2], duration: dur, ease: "power3.in", onComplete: () => {
